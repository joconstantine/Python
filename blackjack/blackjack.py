...
def score_hand(hand):
    ...
    for next_card in hand:
        ...
        if card_value == 1 and not ace:
            ...
            card_value = 11
        score += card_value
        # if we would burst, check if there is an ace and subtract 10
        if score > 21 and ace:
            score -= 10
            ace = False
    return score
...
def deal_player():
    ...
    # # id we would bust, check if there is an ace and subtract
...
# Create the lists to store dealer's and player's hands
dealer_hand = []
player_hand = []

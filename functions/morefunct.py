...
# and default to red if a colour is not given. You may want to review the previous lecture
def circle(page, radius, g, h, line_color="red"):
    page.create_oval(g + radius, h + radius, g - radius, h - radius, outline=line_color, width=2)
...
circle(canvas, 100, 100, -100, "grey")
